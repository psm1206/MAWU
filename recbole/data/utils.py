...
def create_dataset(config):
    ...
    default_file = os.path.join(config['save_dataset_dir'], f'{config["dataset"]}-{dataset_class.__name__}.pth')
...
def save_split_dataloaders(config, dataloaders):
    ...
    """
    ensure_dir(config['save_dataset_dir'])
    save_path = config['save_dataset_dir']
...
def load_split_dataloaders(config):
    ...
    default_file = os.path.join(config['save_dataset_dir'], f'{config["dataset"]}-for-{config["model"]}-dataloader.pth')
